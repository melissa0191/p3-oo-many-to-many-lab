...
class Contract:
    ...
    def contracts_by_date(cls, date):
        ...
        return [contract for contract in sorted_by_date if contract.date == date]
...
mizaki_contracts = mizaki.contracts()

for contract in mizaki_contracts:
    print(
        f"Contract: {contract}, Author: {contract.author.name}, Book Title: {contract.book.title}, Date: {contract.date}, Royalties: {contract.royalties}"
    )
